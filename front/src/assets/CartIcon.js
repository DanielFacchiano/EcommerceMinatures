// Open source SVG data from svgrepo.com

import React from 'react';

export const CartIcon = ({ setToggleCart, toggleCart }) => (
  <svg 
    onClick={() => {
    ...
    >
    <path
    d="M11,13V5c0-0.553-0.448-1-1-1H7.858C7.411,2.28,5.858,1,4,1C1.794,1,0,2.794,0,5s1.794,4,4,4c1.858,0,3.411-1.28,3.858-3H9
